...
If private vulnerability reporting is unavailable, do not disclose details publicly. Send a minimal contact request to `security@nobodyworld.com` so a private reporting channel can be established. Do not include secrets, real prompt contents, or unrelated personal data.
